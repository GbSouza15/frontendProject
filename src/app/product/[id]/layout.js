  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        <nav className="flex items-center justify-around bg-white text-black h-[5rem]">
                  <div className="logo">
                      <svg className="w-[4rem] h-[4rem] bg-white rounded-[100%]" version="1.0" xmlns="http://www.w3.org/2000/svg"
